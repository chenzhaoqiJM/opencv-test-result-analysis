...
```
mkdir build_opencv_rvv && cd build_opencv_rvv
...
禁用RVV:
```
mkdir build_opencv_no_rvv && cd build_opencv_no_rvv
...
```Shell
git clone https://github.com/opencv/opencv_extra.git --recursive
cd ~/build_opencv_rvv/bin
